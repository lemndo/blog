...
public class UploadGiteeImgBed {
     ...
     * 码云私人令牌
     */
    public static final String ACCESS_TOKEN = "d21a5544d22fa99e96f0494d18173425";  //这里不展示我自己的了，需要你自己补充

    /**
     * 码云个人空间名
     */
    public static final String OWNER = "lemndo";
     ...
     * 上传时指定存放图片路径
     */
    public static final String PATH = "/img/"+ DateUtils.getYearMonth()+"/"; //使用到了日期工具类
